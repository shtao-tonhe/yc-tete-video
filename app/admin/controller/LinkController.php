...
class LinkController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        $this->success($Think.\lang('ADD_SUCCESS'), url("Link/index"));
    }
    ...
    public function editPost()
    {
        ...
        $this->success($Think.\lang('EDIT_SUCCESS'), url("Link/index"));
    }
    ...
    public function delete()
    {
        ...
        $this->success($Think.\lang('DELETE_SUCCESS'), url("link/index"));
    }
