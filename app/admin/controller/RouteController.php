...
class RouteController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        $this->success($Think.\lang('ADD_SUCCESS'), url("Route/index", ['id' => $routeModel->id]));
    }
    ...
    public function editPost()
    {
        ...
        $this->success($Think.\lang('EDIT_SUCCESS'), url("Route/index"));
    }
    ...
    public function ban()
    {
        ...
        $this->success($Think.\lang('DISABLED_SUCCESSFULLY'));
    }
    ...
    public function open()
    {
        ...
        $routeModel->isUpdate(true)->save($data);
        $this->success($Think.\lang('ENABLED_SUCCESSFULLY'));
    }
