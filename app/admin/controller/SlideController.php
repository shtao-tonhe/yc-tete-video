...
class SlideController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        $this->success($Think.\lang('ADD_SUCCESS'), url("slide/index"));
    }
    ...
    public function editPost()
    {
        ...
        $this->success($Think.\lang('EDIT_SUCCESS'), url("slide/index"));
    }
    ...
    public function delete()
    {
        ...
        $result         = $slidePostModel->where('id', $id)->find();
        if (empty($result)) {
            $this->error($Think.\lang('SLIDE_NOT_EXIST'));
        }

        //如果存在页面。则不能删除。
        $slidePostCount = Db::name('slide_item')->where('slide_id', $id)->count();
        if ($slidePostCount > 0) {
            $this->error($Think.\lang('HAS_SLIDE_PAGES_CANNOT_DELETED'));
        }
        ...
        $this->success($Think.\lang('DELETE_SUCCESS'), url("slide/index"));
    }
}